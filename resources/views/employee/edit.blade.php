     ...
     <div id="wrapper">
         ...
         <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
             <div class="navbar-header">
                 ...
                 <a class="navbar-brand" href="index.html">TOKO BUAH</a>
             </div>
             <!-- /.navbar-header -->
             ...
             <div class="navbar-default sidebar" role="navigation">
                 <div class="sidebar-nav navbar-collapse">
                     <ul class="nav" id="side-menu">
                         ...
                         <li>
                             <a href="{{ url('/Product') }}"><i class="fa fa-dashboard fa-fw"></i> Product</a>
                         </li>
                         <li>
                         ...
                         <div class="panel-body">
                             <div class="row">
                                 ...
                                 @foreach ($employee as $employeelist)
                                     <form role="form" action="{{ route('Employee.update', $employeelist->employee_id) }}" method="post">
                                        {{ csrf_field() }}  {{ method_field('PUT') }}
                                         ...
                                         <div class="form-group">
                                             ...
                                             <input class="form-control" type="text" name="txt_phone_number" value="{{ $employeelist->employee_phone_number }}"/>
                                         </div>
                                @endforeach
